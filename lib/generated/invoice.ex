defmodule Stripe.Invoice do
  ...
  (
    @typedoc "The parent item that generated this invoice."
    @type parent :: %{
            optional(:quote_details) => quote_details,
            optional(:subscription_details) => subscription_details,
            optional(:type) => :quote | :subscription
          }
  )
  ...
  (
    @typedoc "The details about the quote that generated this invoice."
    @type quote_details :: %{optional(:quote) => binary}
  )
  ...
  (
    @typedoc "The details about the subscription that generated this invoice."
